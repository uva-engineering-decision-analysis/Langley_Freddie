---
title: 'Decisions & Diabetes'
 # subtitle: ''
author: "Fredrienne Langley"
Semester: "Spring 2020" 
Course:   SYS 6014 Decision Analysis
---
# Introduction
- The cost of Type 2 Diabetes medication has skyrocketed in the 21st century. 
- The cost of insulin can surge to over $250 for a vial of insulin and due to the sensitivity of a patient’s glucose level, multiple vials may be required for their therapeutic intervention. 
---
# Problem
- Patient C has been diagnosed with a chronic disease called Diabetes.
- Patient C has been experiencing A1C test results if 10.4% and 11.1%. The standard that patients should shoot for is under 5.5%.
...
# Decision Model
## Stage 1
This stage is very important because it provides the practice of medical ethics within the model.
1) Input the patient's A1C
2) From the effectiveness data, a selection of multiple drug options will be presneted that meet the clinical threshold.
## Stage 2
To provide a drug from the filtered list that is the least expensive.
---
# Payoffs
...
---
# Predictive Model
Using the percentage of the treatment effectiveness, we will subtract that amount from the baseline A1C.
